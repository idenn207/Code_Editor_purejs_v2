...
(function(CodeEditor) {
  ...
  class ActivityBar {
    ...
    addItem(id, options) {
      ...
      var badge = options.badge !== undefined ? options.badge : null;
      ...
      // Add to DOM
      var targetContainer = position === 'bottom' ? this._bottomElement : this._topElement;
    ...
    setActiveView(viewId) {
      var previousView = this._activeView;
      this._activeView = viewId;
      this._updateActiveState();
      this._emit('viewChange', { view: viewId, previousView: previousView });
    }
    ...
    setBadge(itemId, count) {
      ...
      var badgeEl = item.element.querySelector('.ide-activity-badge');
  ...
  CodeEditor.IDE.ActivityBar = ActivityBar;
